export default {
    ...
    'infoDialog': {
        ...
        'aboutUs': 'О нас',
        'description': 'Проект помогает улучшить университетский опыт. Пока студенты видят загруженность аудиторий в реальном времени и могут найти место для учёбы или отдыха, преподаватели и сотрудники могут отслеживать посещаемость лекций.',
        ...
        'afterThought': 'Будем рады узнать ваше мнение! Любое предложение поможет сделать приложение лучше.',
        'link': 'здесь'
    },
    'auth': {
        'title': 'Авторизация',
