export default {
  ...
  settingsPage: {
    ...
    deleteCityConfirm: 'Вы уверены, что хотите удалить город {name}?',
    cityDeleteBuildingsWarning: 'Удалить город нельзя, пока за ним закреплены здания',
    cityCreated: 'Город успешно создан',
    cityUpdated: 'Город успешно обновлён',
    cityDeleted: 'Город успешно удалён',
    createCity: 'Создать',
    updateCity: 'Изменить',
    nameRu: 'Название (рус.)',
    nameEn: 'Название (англ.)',
    editCity: 'Редактировать город',
    addBuildingButton: 'Добавить здание',
    deleteBuildingConfirm: 'Вы действительно хотите удалить здание по адресу: {address}?',
    buildingDeleteAuditoriesWarning: 'Удалить здание нельзя, пока за ним закреплены аудитории',
    buildingCreated: 'Здание успешно создано',
    buildingUpdated: 'Здание успешно обновлено',
    buildingDeleted: 'Здание успешно удалено',
    addressRu: 'Адрес (рус.)',
    addressEn: 'Адрес (англ.)',
    floorCount: 'Количество этажей',
    editBuilding: 'Редактировать здание',
    addCameraButton: 'Добавить камеру',
    deleteCameraConfirm: 'Вы действительно хотите удалить камеру с адресом: {mac}?',
    cameraCreated: 'Камера успешно создана',
    cameraUpdated: 'Камера успешно обновлена',
    cameraDeleted: 'Камера успешно удалена',
    editCamera: 'Редактировать камеру',
    attachedCameras: 'Закреплённые камеры',
    freeCameras: 'Свободные камеры',
