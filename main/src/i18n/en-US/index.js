export default {
  ...
  settingsPage: {
    ...
    addCameraButton: 'Add camera',
    deleteCameraConfirm: 'Are you sure you want to delete camera at address: {mac}?',
    cameraCreated: 'Camera created successfully',
    cameraUpdated: 'Camera updated successfully',
    cameraDeleted: 'Camera deleted successfully',
    editCamera: 'Edit camera',
    attachedCameras: 'Attached cameras',
    freeCameras: 'Free cameras',
